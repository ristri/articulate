          ...
          <section className="hero text-center">
            <div className="container-sm">
              <div className="hero-inner">
                <h1 className="hero-title h2-mobile mt-0 is-revealing">Articulate </h1>
                <p className="hero-paragraph is-revealing">Get Relevant Videos From Your Favorite Articles
                          </p>
                ...
                <div className="hero-form newsletter-form field field-grouped is-revealing">
                  <div className="control control-expanded">
                    <input onChange={this.handleURLChange} className="input" type="url" name="ar-url" placeholder="Your article URL…" value={this.state.url} />
                  </div>
                  <div className="control">
                    <a onClick={this.handleClick} className="button button-primary button-block button-shadow" href="#">Go</a>
                  </div>
                </div>
                <br />
